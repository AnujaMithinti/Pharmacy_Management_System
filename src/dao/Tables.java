...
public class Tables {
    ...
    public static void main(String[] args) {
        try {
            ...
            //   st.executeUpdate("insert into appuser (userRole,name,dob,mobileNumber,email,username,password,address) values('Admin','Admin','27-06-2003','7989206599','anujamithinit27@gmail.com','admin','admin','India')");
